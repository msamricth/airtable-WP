...
{
    error_log('airtable_WP_menu() function called.');
    add_options_page(
...
function airtable_wp_enqueue_scripts()
{
    ...
    wp_enqueue_script('airtable-wp-main', plugins_url('build/index.js', __FILE__), array(''), null, true);
    wp_localize_script('airtable-wp-main', 'airtableWpSettingsObject', array(
        'apiKey' => $apiKey,
        'baseId' => $baseId,
        'tableName' => $tableName
    )
...
add_action('admin_enqueue_scripts', 'airtable_wp_enqueue_scripts');